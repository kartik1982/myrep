...
public class TC_Network_DNS extends TestSuiteBase{
	...
	public void testCase_C1() throws InterruptedException{
		...
		//#Disable DNS assigned by DHCP server Automatically
		xmslocallib.selectRadioButton("Use DNS settings assigned by DHCP", 2);
		//Set Doimain Server name
		xmslocallib.setText("DNS Domain", "Xirrus.com");
		//Domain Server-1 IP
		xmslocallib.setText("DNS Server 1", "10.100.1.10");
		//Domain Server-2 IP
		xmslocallib.setText("DNS Server 2", "10.100.2.10");
		//Domain Server-3 IP
		xmslocallib.setText("DNS Server 3", "10.100.59.77");
