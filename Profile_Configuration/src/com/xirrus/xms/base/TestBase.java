...
public class TestBase {
	...
	public static DataFile_Reader suite_Profile_Menu_xls = null;
	public static DataFile_Reader suite_Profile_General_xls = null;
	public static DataFile_Reader suite_Profile_Network_xls = null;
...
//	NavigateTo navigatelib = new NavigateTo();
	public void initialize() throws Exception {
		if (!isInitialized) {
			...
			suite_Profile_Menu_xls = new DataFile_Reader(
					System.getProperty("user.dir")
							+ "\\src\\com\\xirrus\\xms\\xls\\TS_Configure_Profile_Menu.xlsx");
			suite_Profile_General_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Profile_General.xlsx");
			suite_Profile_Network_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Profile_Network.xlsx");
