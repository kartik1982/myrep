...
public class TestBase {
	...
	public static DataFile_Reader suite_Array_General_xls = null;
	public static DataFile_Reader suite_Array_Network_xls = null;
	public static DataFile_Reader suite_Array_VLAN_xls = null;
	public static DataFile_Reader suite_Array_Services_xls = null;
	public static DataFile_Reader suite_Array_Security_xls = null;
	public static DataFile_Reader suite_Array_SSIDs_xls = null;
	public static DataFile_Reader suite_Array_Groups_xls = null;
	public static DataFile_Reader suite_Array_IAPs_xls = null;
	public static DataFile_Reader suite_Array_Filters_xls = null;
	public static DataFile_Reader suite_Array_Tunnels_xls = null;
...
//	NavigateTo navigatelib = new NavigateTo();
	public void initialize() throws Exception {
		if (!isInitialized) {
			...
			suite_Array_General_xls = new DataFile_Reader(System.getProperty("user.dir")
							+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_General.xlsx");
			suite_Array_Network_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_Network.xlsx");
			suite_Array_VLAN_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_VLAN.xlsx");
			suite_Array_Services_xls = new DataFile_Reader(System.getProperty("user.dir")
							+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_Services.xlsx");
			suite_Array_Security_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_Security.xlsx");
			suite_Array_SSIDs_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_SSIDs.xlsx");
			suite_Array_Groups_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_Groups.xlsx");
			suite_Array_IAPs_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_IAPs.xlsx");
			suite_Array_Filters_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_Filters.xlsx");
			suite_Array_Tunnels_xls = new DataFile_Reader(System.getProperty("user.dir")
					+ "\\src\\com\\xirrus\\xms\\xls\\TS_Array_Tunnels.xlsx");
