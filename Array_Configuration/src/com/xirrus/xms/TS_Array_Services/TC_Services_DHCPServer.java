...
@Test
public class TC_Services_DHCPServer extends TestSuiteBase{
	...
	public void testCase_verifyDHCPServerDefaultValues()throws InterruptedException, IOException{
		...
		App_Log.debug("Ref-4.1.9_GUI-Verification:-Verify Gateway for DHCP Server by Default 192.168.2.1");
	...
	public void testCase_verifyAddDHCPServer()throws InterruptedException, IOException{
		...
		App_Log.debug("Ref-4.2.5_CLI-Verification:-Verify Max Lease for DHCP Server");
		...
		App_Log.debug("Ref-4.2.5_SNMP-Verification:-Verify Max Lease for DHCP Server");
		...
		App_Log.debug("Ref-4.2.6_CLI-Verification:-Verify Start IP Range for DHCP Server");
		...
		App_Log.debug("Ref-4.2.6_SNMP-Verification:-Verify Start IP Range for DHCP Server");
		...
		App_Log.debug("Ref-4.2.7_CLI-Verification:-Verify End IP Range for DHCP Server");
		...
		App_Log.debug("Ref-4.2.7_SNMP-Verification:-Verify End IP Range for DHCP Server");
		...
		App_Log.debug("Ref-4.2.8_CLI-Verification:-Verify Default Subnet Mask for DHCP Server");
		...
		App_Log.debug("Ref-4.2.8_SNMP-Verification:-Verify Default Subnet Mask for DHCP Server");
		...
		App_Log.debug("Ref-4.2.9_GUI-Verification:-Verify Gateway for DHCP Server");
		...
		App_Log.debug("Ref-4.2.9_CLI-Verification:-Verify Gateway for DHCP Server");
		...
		App_Log.debug("Ref-4.2.9_SNMP-Verification:-Verify Gateway for DHCP Server");
		...
		App_Log.debug("Ref-4.2.10_CLI-Verification:-Verify Default Domain for DHCP Server");
		...
		App_Log.debug("Ref-4.2.10_SNMP-Verification:-Verify Default Domain for DHCP Server");
		...
		App_Log.debug("Ref-4.2.11_CLI-Verification:-Verify Default DNS Server 1 for DHCP Server");
		...
		App_Log.debug("Ref-4.2.11_SNMP-Verification:-Verify Default DNS Server 1 for DHCP Server");
		...
		App_Log.debug("Ref-4.2.12_CLI-Verification:-Verify Default DNS Server 2 for DHCP Server");
		...
		App_Log.debug("Ref-4.2.12_SNMP-Verification:-Verify Default DNS Server 2 for DHCP Server");
		...
		App_Log.debug("Ref-4.2.13_CLI-Verification:-Verify Default DNS Server 3 for DHCP Server");
		...
		App_Log.debug("Ref-4.2.13_SNMP-Verification:-Verify Default DNS Server 3 for DHCP Server");
	...
	public void testCase_verifyEditDHCPServer()throws InterruptedException, IOException{
		...
		App_Log.debug("Ref-4.3.1_GUI-Verification:-Verify Enable State for DHCP Server");
		//get value for DHCP Server State Default in Add DHCP Pool by GUI
		if(xmslocallib.isCheckboxSelected(2))dhcpEnableGUI="enabled"; else dhcpEnableGUI="disabled";
		boolean guiResult1=xmslocallib.verifyStringequals("DHCPEnableStateGUI", this.getClass().getSimpleName(), methodName, dhcpEnableGUI, dhcpEnableExp);
		App_Log.debug("Ref-4.3.1_CLI-Verification:-Verify Enable State for DHCP");
		//get value for DHCP Server State Default in Add DHCP Pool by CLI
		dhcpEnableCLI=xmslocallib.getValuebyCLI_DHCPServer(arrayIPadd, dhcpNameExp, "State");
		boolean cliResult1=xmslocallib.verifyStringequals("DHCPEnableStateCLI", this.getClass().getSimpleName(), methodName, dhcpEnableCLI, dhcpEnableExp);
		App_Log.debug("Ref-4.3.1_SNMP-Verification:-Verify Enable State for DHCP");
		//get value for DHCP Server State Default in Add DHCP Pool by SNMP
		dhcpEnableSNMP=xmslocallib.getValueBySNMP(arrayIPadd, communityStr, dhcpEnableOID);
		...
		App_Log.debug("Ref-4.3.9_GUI-Verification:-Verify Gateway for DHCP Server");
		//get Gatway for DHCP Server by GUI
		dhcpGatewayGUI= xmslocallib.getText("Gateway");
		boolean guiResult9=xmslocallib.verifyStringequals("DHCPServerGatewayGUI", this.getClass().getSimpleName(), methodName, dhcpGatewayGUI, dhcpGatewayExp);
		App_Log.debug("Ref-4.3.9_CLI-Verification:-Verify Gateway for DHCP Server");
		//get Gatway for DHCP Server by CLI
		dhcpGatewayCLI=xmslocallib.getValuebyCLI_DHCPServer(arrayIPadd, dhcpNameExp, "IP gateway");
		boolean cliResult9=xmslocallib.verifyStringequals("DHCPServerGatewayCLI", this.getClass().getSimpleName(), methodName, dhcpGatewayCLI, dhcpGatewayExp);
		App_Log.debug("Ref-4.3.9_SNMP-Verification:-Verify Gateway for DHCP Server");
		//get Gatway for DHCP Server by SNMP
		dhcpGatewaySNMP=xmslocallib.getValueBySNMP(arrayIPadd, communityStr, dhcpGatewayOID);
		boolean snmpResult9=xmslocallib.verifyStringequals("DHCPServerGatewaySNMP", this.getClass().getSimpleName(), methodName, dhcpGatewaySNMP, dhcpGatewayExp);
	...
	public void testCase_verifyDeleteDHCPServer()throws InterruptedException, IOException{
		...
		try{	
			...
			xmslocallib.clickLink("Services");
			xmslocallib.clickLink("DHCP Server");
			App_Log.debug("Ref-4.4_GUI-Verification:-Verify DHCP Server Deleted");
			//Get DHCP Server by GUI
			...
			App_Log.debug("Ref-4.4_CLI-Verification:-Verify DHCP Server Deleted");
			//Get DHCP Server by CLI
			dhcpNameCLI=xmslocallib.getValuebyCLI_DHCPServer(arrayIPadd, "NODHCP", "");
	...
	public void testCase_verifyDHCPServerEndIPRangeFieldValidation()throws InterruptedException, IOException{
		...
		xmslocallib.pause(10);
		//Verify warning message	
		App_Log.debug("Ref-4.9_GUI-Verification:-Verify End IP Range should not be empty");
		...
		App_Log.debug("Ref-4.9_GUI-Verification:-Verify End IP Range should not accept Invalid input");
